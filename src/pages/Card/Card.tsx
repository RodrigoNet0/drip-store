...
export default function CardPage() {
  ...
  return (
    <div className=" bg-[#C92071] flex justify-center items-center h-screen">
      <Card className="bg-slate-100 w-96 shadow-md rounded-lg p-4">
        <CardHeader>
          <CardTitle className="font-extrabold">Cadastre-se na Loja</CardTitle>
          <CardDescription className="font-semibold">Drip Store é o maior Barato </CardDescription>
        </CardHeader>
